...
//         // Dynamic where clause - search aur role filter dono optional hai
//         const whereClause = {
//             isDelete: false, // yaha isDelete ko "permanently deleted" ke liye use kar rahe
//         };
...
//         if (role) {
//             whereClause.role = role; // ADMIN / USER / VENDOR
//         }
...
//                     isVerified: true,
//                     imageUrl: true,
//                     isDelete: true, // isko hi "active/inactive" flag ki tarah treat kar rahe
//                     createdAt: true,
//                     updatedAt: true,
//                     // Address count bhi dikha denge list me, taaki admin ko andaza rahe
//                     _count: {
...
// ---------------------------------------------------------------------
// 2) EK SPECIFIC USER KA FULL DETAIL + USKE SAARE ADDRESSES
