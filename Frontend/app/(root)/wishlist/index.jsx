...
//     // Page open hote hi wishlist fetch karo (guest ho ya user, dono ke liye kaam karega)
//     useEffect(() => {
    ...
    return (
        <View className="flex-1 bg-gray-50" style={{ paddingTop: insets.top }}>
            ...
            <View className="bg-white px-4 py-3 flex-row items-center justify-between border-b border-gray-100">
                ...
                {items.length > 0 && (
                    <TouchableOpacity onPress={handleClearAll} className="flex-row items-center gap-1 p-1" hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
                        <Trash2 size={16} color="#dc2626" />
                        <Text className="text-xs font-semibold text-red-600">Clear All</Text>
                    </TouchableOpacity>
                )}
