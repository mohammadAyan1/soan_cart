        ...
        <View className="flex-1 bg-gray-50" style={{ paddingTop: insets.top }}>
            ...
            <View className="bg-white px-4 py-3 flex-row items-center justify-between border-b border-gray-100">
                <View className="flex-row items-center gap-3">
                    <TouchableOpacity onPress={() => router.back()} className="p-1" hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
                        <ChevronLeft size={24} color="#111827" />
                    </TouchableOpacity>
                    <View className="flex-row items-center gap-2">
                        <KeyRound size={20} color="#16a34a" />
                ...
                {step === 1 ? (
                    ...
                    <>
                        ...
                        <TextInput
                            ...
                            className="border border-gray-200 rounded-xl px-4 py-3 mb-1 text-center text-[20px] tracking-[8px] text-gray-900 bg-white"
                        />
                        <TouchableOpacity onPress={handleResendOtp} disabled={resendLoading} className="self-end mb-4" hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
                            {resendLoading ? (
                                <ActivityIndicator color="#16a34a" size="small" />
                            ) : (
                                <Text className="text-[12.5px] text-green-600 font-semibold">
                        ...
                        <TouchableOpacity onPress={() => setStep(1)} className="items-center mt-5" hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
                            <Text className="text-[13px] text-gray-500">
                                Galat email daala? <Text className="text-green-600 font-semibold">Wapas jao</Text>
                            </Text>
                        </TouchableOpacity>
