...
const VendorLayout = () => {
    ...
    return (
        <div className="min-h-screen flex bg-gray-100">
            {/* Sidebar */}
            <aside className="w-64 bg-emerald-900 text-gray-100 flex flex-col">
                <div className="h-16 flex items-center px-6 text-lg font-bold border-b border-emerald-800">
                    Vendor Panel
                </div>
